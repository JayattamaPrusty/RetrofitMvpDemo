...
public interface RetrofitInterfaceMethodCall {
     ...
     * */
    @GET("bins/path/")
    Call<NewsModel.Row> getNoticeDataData(@Query("company_no") int companyNo);
     ...
     * */
    @GET("group/{id}/users")
    Call<List<NewsModel.Row>> groupList(@Path("id") int groupId);
     ...
     * */
    @GET("group/{id}/users")
    Call<List<NewsModel.Row>> groupList(@Path("id") int groupId, @Query("sort") String sort);
    ...
    Call<List<NewsModel.Row>> groupList(@Path("id") int groupId, @QueryMap Map<String, String> options);
     ...
     */
    @POST("notice/new")
    Call<NewsModel.Row> createNotice(@Body NewsModel.Row notice);
    ...
    @FormUrlEncoded
    @POST("notice/edit")
    Call<NewsModel.Row> updateNotice(@Field("id") String id, @Field("title") String title);
    ...
    @Multipart
    @PUT("notice/photo")
    Call<NewsModel.Row> updateNotice(@Part("photo") RequestBody photo, @Part("description") RequestBody description);
    ...
    @GET("notice/list")
    Call<List<NewsModel.Row>> NoticeList();
    ...
    Call<NewsModel.Row> getNotice(@Path("title") String title);
     ...
     * */
    @GET("notice")
    Call<NewsModel.Row> getNoticeUsingHeader(@Header("Authorization") String authorization);
